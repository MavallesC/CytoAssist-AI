...
1. **Lectura y Generación de Thumbnail ([wsi_reader.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/wsi_reader.py)):**
...
2. **Control de Calidad y Máscaras ([masks.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/masks.py)):**
...
3. **Extracción Inteligente de ROIs ([roi_extraction.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/roi_extraction.py)):**
...
4. **Tamizaje de Candidatos Celulares ([candidate_detection.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/candidate_detection.py)):**
...
5. **Clasificación de Tipo de Candidato ([candidate_detection.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/candidate_detection.py)):**
...
6. **Inferencia y Clasificación IA ([inference.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/inference.py)):**
...
7. **Consolidación y Reporte ([aggregation.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/aggregation.py), [reports.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/reports.py)):**
   El orquestador en segundo plano ([runner.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/runner.py)) consolida las predicciones en una única transacción de base de datos (`transaction.atomic`) y ejecuta las reglas de agregación clínica. Genera mapas de calor de densidad celular y de anormalidades, y compila el reporte clínico HTML.

8. **Módulo de Exportación Jerárquica y Portabilidad ([views.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/views.py)):**
...
La función de consolidación diagnóstica `infer_preliminary_wsi_class` (implementada en el servicio [aggregation.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/aggregation.py)) procesó el inventario de células del caso **WSI–01** aplicando las siguientes reglas lógicas del sistema:
...
Para dotar al sistema de explicabilidad diagnóstica, la capa de visualización ([visualization.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/visualization.py)) generó los siguientes recursos espaciales:
...
3. **Concordancia Exacta por Categoría Bethesda:** $30.0\%$ (3 de 10 casos). El sistema demostró coincidencia diagnóstica precisa en los casos 04, 07 y 08. Para los 7 casos restantes, se observaron discrepancias menores que se dividen en dos comportamientos clínicos esperados:
   - *Sobre-diagnóstico (LSIL clasificado como HSIL):* Ocurrió en los casos 01, 03, 05 y 06. Esto se debe a la estricta lógica de prioridad clínica Bethesda implementada en [aggregation.py](file:///C:/Users/JhosepSF/Documents/Jhosep/Trabajos/CytoAssist%20AI/wsi_analysis/services/aggregation.py): la detección de un número reducido de células con características morfológicas atípicas asociadas a HSIL (incluso 2 células en el caso 01) eleva preventivamente el diagnóstico global del portaobjetos. Clínicamente, esto actúa como una medida de seguridad que maximiza la sensibilidad diagnóstica.
